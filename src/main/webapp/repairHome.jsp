...
<body>
	...
	<div class="form mx-auto">
	  ...
	  <div class="list-group">
		<button type="button" style="width:20%;" onclick="document.location='repairType.jsp'" class="btn btn-info mt-5 mx-auto">Add New Repairs</button>
		<button type="button" style="width:20%;" onclick="document.location='searchOngoingRepairs.jsp'"class="btn btn-info mt-5 mx-auto">Ongoing Repair</button>
		<button type="button" style="width:20%;" onclick="document.location='searchCompletedRepairs.jsp'" class="btn btn-info mt-5 mx-auto">Completed Repair</button>
		<button type="button" style="width:20%;" onclick="document.location='repairReportSelect.jsp'"class="btn btn-info mt-5 mx-auto">Report</button>
	  </div>
	</div>
