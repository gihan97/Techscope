...
<body>
  ...
  <h2 class="text-center">Computer Repair</h2>
  
	<div class="container p-3">
	  <form class="text-center" action="repairComputer" method="post">
  
  
		<div class="form-group row">
		  <label for="" class="col-sm-2 col-form-label">Customer ID</label>
		  <div class="col-sm-10">
			<input type="number" name="cID"  style="width:57%;"  class="form-control" required/>
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<input type="text" name="com"  style="width:57%;"  class="form-control" required/>
		  </div>
		</div>
  
		<div class="form-group row">
		  <label for="" class="col-sm-2 col-form-label">Name of the Deliver</label>
		  <div class="col-sm-10">
			<input type="text" name="del"  style="width:57%;"  class="form-control" required/>
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<input type="date" name="date"  style="width:57%;"  class="form-control" required/>
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<textarea name="des" rows="8"  style="width:57%;" class="form-control" cols="80"></textarea>
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<input type="text" name="spare"  style="width:57%;"  class="form-control" />
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<input type="number" name="qty"   style="width:57%;" class="form-control" />
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<input type="number" name="cost"  style="width:57%;"  class="form-control" required/>
		  </div>
		</div>
