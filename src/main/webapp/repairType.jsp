...
<body>
	...
	<div class="form mx-auto">
	  ...
	  <div class="list-group">
		<button type="button" style="width:25%;" onclick="document.location='repairFormAir.jsp'" class="btn btn-info mt-5 mx-auto">Air Condition Repair</button>
		<button type="button" style="width:25%;" onclick="document.location='repairFormComputer.jsp'" class="btn btn-info mt-5 mx-auto">Computer Repair</button>
		<button type="button" style="width:25%;" onclick="document.location='repairFormOther.jsp'"class="btn btn-info mt-5 mx-auto">Other Electronic Repair</button>
	  </div>
	</div>
