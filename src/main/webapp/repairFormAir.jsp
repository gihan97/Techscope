...
<body>
  ...
  <h2 class="text-center">Air Condition Repair</h2>
  
	<div class="container p-3">
	  <form class="text-center" action="repairAir" method="post">
  
  
		<div class="form-group row">
		  <label for="" class="col-sm-2 col-form-label">Customer ID</label>
		  <div class="col-sm-10">
			<input type="number" name="cID" class="form-control" style="width:57%;" required/>
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<textarea name="des" rows="8"  style="width:57%;" class="form-control"></textarea>
		  </div>
		</div>
