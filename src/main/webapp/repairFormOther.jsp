...
<body>
  ...
  <h2 class="text-center">Other Electronic Repair</h2>
  
	<div class="container p-3">
	  <form class="text-center" action="repairOther" method="post">
  
  
		<div class="form-group row">
		  <label for="" class="col-sm-2 col-form-label">Customer ID</label>
		  <div class="col-sm-10">
			<input type="number" class="form-control"  style="width:57%;"  name="cID" required />
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<input type="text" name="com" class="form-control"  style="width:57%;"  required />
		  </div>
		</div>
  
  
		<div class="form-group row">
		  <label for="" class="col-sm-2 col-form-label">Date of Acceptance</label>
		  <div class="col-sm-10">
			<input type="date" name="date" class="form-control"  style="width:57%;"  required />
		  </div>
		</div>
  
  
		<div class="form-group row">
		  <label for="" class="col-sm-2 col-form-label">Choose Devices</label>
		  <div class="col-sm-10">
			<textarea name="dev" rows="8" cols="80"  style="width:57%;" class="form-control" required></textarea>
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<textarea name="des" rows="8" cols="80" class="form-control"  style="width:57%;"  required></textarea>
		  </div>
		</div>
  
		<div class="form-group row">
		  <label for="" class="col-sm-2 col-form-label">Spare Parts</label>
		  <div class="col-sm-10">
			<input type="text" name="spare" class="form-control"  style="width:57%;" />
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-sm-10">
			<input type="number" name="qty" class="form-control"  style="width:57%;"  />
		  </div>
		</div>
  
		<div class="form-group row">
		  <label for="" class="col-sm-2 col-form-label">Estimated Cost</label>
		  <div class="col-sm-10">
			<input type="number"name="cost" class="form-control"  style="width:57%;"  required/>
		  </div>
		</div>
